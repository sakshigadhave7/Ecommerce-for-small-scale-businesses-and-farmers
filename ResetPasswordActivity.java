...
public class ResetPasswordActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        titleQuestion = findViewById(R.id.tittle_question);
    ...
    protected void onStart()
    {
        ...
        if(check.equals("settings"))
        {
            ...
            titleQuestion.setText("Please set the answers for following security questions");
        ...
        else
        {
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>()
            {
                ...
                public void onComplete(@NonNull @NotNull Task<Void> task)
                {
                    ...
                    {
                        Toast.makeText(ResetPasswordActivity.this, "You have set the questions successfully.", Toast.LENGTH_SHORT).show();
        ...
        if(!phone.equals("") && !answer1.equals("") && !answer2.equals(""))
        {
            ...
            ref.addValueEventListener(new ValueEventListener()
            {
                ...
                public void onDataChange(@NonNull @NotNull DataSnapshot dataSnapshot)
                {
                    ...
                    {
                        Toast.makeText(ResetPasswordActivity.this, "This phone number doesn not exist.", Toast.LENGTH_SHORT).show();
